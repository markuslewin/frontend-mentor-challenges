    ...
    <>
      ...
      <div className="desktop:center isolate overflow-hidden bg-[hsl(0_0%_9%)] text-FFFFFF">
        <div className="desktop:layout grid desktop:pb-[3.625rem] desktop:pt-[9.6875rem]">
          <div className="order-last col-start-1 row-start-1 grid grid-rows-[198fr_auto_112fr] px-6 text-center tablet:grid-rows-[216fr_auto_167fr] desktop:col-span-9 desktop:col-start-auto desktop:row-start-auto desktop:grid-rows-[70fr_auto_100fr] desktop:px-0 desktop:text-start">
