...
const overlay: Variants = {
  visible: { background: "hsl(0 0% 0% / 0.4)" },
  hidden: { background: "hsl(0 0% 0% / 0)" },
};
...
export const ReceiptDialog = ({ isOpen, receipt }: ReceiptDialog) => {
  ...
  return (
    <AlertDialog.Root open={isOpen}>
      <AlertDialog.Portal>
        <AlertDialog.Overlay
          className="fixed inset-0 z-10 grid grid-cols-[minmax(auto,33.75rem)] items-center justify-center overflow-y-auto p-6"
          asChild
        >
          <motion.div
            variants={overlay}
          ...
          >
            ...
            >
              <motion.div variants={content} transition={{ duration: 0.2 }}>
